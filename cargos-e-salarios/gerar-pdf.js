...
const css = `
  ...
  * { box-sizing: border-box; }
  body { font-family: Arial, Helvetica, sans-serif; font-size: 10pt; color: #1a1510; line-height: 1.38; }
  p { margin: 0 0 6pt 0; text-align: justify; }
  h1 { font-size: 15pt; margin: 18pt 0 8pt; padding-bottom: 3pt; border-bottom: 1.5pt solid #da8d00; page-break-after: avoid; }
  h2 { font-size: 11.5pt; margin: 12pt 0 5pt; page-break-after: avoid; }
  h3 { font-size: 10pt; color: #5a4a2a; margin: 8pt 0 4pt; page-break-after: avoid; }
  ...
  td, th { border: 0.5pt solid #c9c1b0; padding: 3pt 4.5pt; vertical-align: middle; }
  td p { margin: 0 0 1pt 0; text-align: left; }
  thead td, thead th { background: #e9e1d0; font-weight: bold; font-size: 8.5pt; }
  table.cover td { background: #f3efe6; border: 0.5pt solid #da8d00; border-left: 3pt solid #da8d00; padding: 7pt 10pt; }
  table.cover td p { font-size: 9.5pt; }
  table.section td { background: #f3efe6; }
  .pb { page-break-before: always; }
  .cover { margin-top: 110pt; }
  .cover .brand { font-size: 22pt; font-weight: bold; letter-spacing: 6pt; margin: 0; }
  .cover .tag { font-size: 8pt; color: #da8d00; font-weight: bold; letter-spacing: 3pt; margin-bottom: 60pt; }
  .cover .title { font-size: 28pt; font-weight: bold; margin: 0 0 6pt; }
  .cover .sub { font-size: 14pt; color: #666; margin-bottom: 30pt; }
...
(async () => {
  ...
  const coverHtml = `<div class="cover">
    <p class="brand">LUSATRAVEL</p><p class="tag">T R A V E L &nbsp; A G E N C Y</p>
  ...
  body = body.replace(/<tr><td colspan="\d+">/g, '<tr class="section"><td class="sectioncell" style="background:#f3efe6;font-weight:bold;color:#5a4a2a;font-size:8.5pt" colspan="7">');
  ...
  await pg.pdf({
    ...
    headerTemplate: `<div style="width:100%;font-family:Arial;font-size:7pt;color:#666;padding:0 20mm;display:flex;justify-content:space-between;border-bottom:0.5pt solid #c9c1b0;margin-top:6mm"><span>Lusatravel &nbsp;·&nbsp; Programa de Cargos e Salários &nbsp;·&nbsp; v1.1</span><span class="pageNumber"></span></div>`,
    footerTemplate: `<div style="width:100%;font-family:Arial;font-size:6.5pt;color:#666;text-align:center;padding:0 20mm;margin-bottom:5mm">Documento interno de circulação restrita &nbsp;·&nbsp; Regulamento sujeito à prevalência da CCT 2026/2027 SECLITUS × SINDETUR-PR e da legislação vigente</div>`,
  });
  await browser.close();
